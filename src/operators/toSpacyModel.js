...
const { map, mergeMap, share } = require('rxjs/operators');
...
const mapTagsToPredictions = () => tags => {

};

const toSpacyModel = ({spacyUrl = process.env.NLP_SERVICE_URL} = {}) => (
  words$ => words$.pipe(
    _extractWordTags({spacyUrl}),
    mapTagsToPredictions()
  )
);

module.exports = matchStringPatterns;
